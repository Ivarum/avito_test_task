# Автоматизация тестирования учебной страницы "Модерация Авито"

**Описание проекта:** Проект содержит набор автоматизированных UI-тестов для проверки критического функционала страницы: логики сортировки объявлений и обновления статистики (таймер).

### Что было автоматизировано:
1. **Тестирование сортировки:** Написаны автотесты для проверки сортировки карточек по цене, категории и специальным тегам. Реализована проверка валидации данных.
2. **Тестирование таймера:** Написаны сценарии для проверки поведения таймера: остановка, запуск и принудительное обновление.

### Стек технологий и паттерны (Уточните у себя в репозитории):
